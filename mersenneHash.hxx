...
private:
  ...
  static inline void
  setGen(tinymt64_t &gen, const vr_packArg<REALTYPE, 1> &pack, uint64_t seed) {
    const uint64_t keys[2] = {
        seed, realToUint64_reinterpret_cast<REALTYPE>(pack.arg1)};
    tinymt64_init_by_array(&gen, keys, 2);
  };

  static inline void setGen(tinymt64_t &gen, const vr_packArg<double, 2> &pack,
                            uint64_t seed) {
  ...
  static void inline setGen(tinymt64_t &gen, const vr_packArg<float, 2> &pack,
                            uint64_t seed) {
  ...
  static inline void setGen(tinymt64_t &gen, const vr_packArg<double, 3> &pack,
                            uint64_t seed) {
  ...
  static inline void setGen(tinymt64_t &gen, const vr_packArg<float, 3> &pack,
                            uint64_t seed) {
